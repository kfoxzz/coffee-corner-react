        ...
        <Row>
          <Col>
            <ListGroup variant="flush" className="text-center">
              ...
              <Link className="link-unstyled link-light" to="/contact">
                Contact
              </Link>
            </ListGroup>
          </Col>
          <Col className="text-center">
            <p>
              <a className="zoom" href="http://facebook.com/">
                <i className="fab fa-facebook fa-2x text-white"></i>
              </a>{' '}
              <a className="zoom" href="http://instagram.com/">
                <i className="fab fa-instagram fa-2x text-white"></i>
              </a>{' '}
              <a className="zoom" href="http://yelp.com/">
                <i className="fab fa-yelp fa-2x text-white"></i>
              </a>
            </p>
