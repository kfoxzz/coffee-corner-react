...
function Menu() {
    ...
    function renderItems(items) {
        return items.map(item => (
            <div key={item.id}>
                <li>{item.name}<br /><small>{item.price}</small></li>
                <br />
            </div>
        ))
    }
    ...
    return (
        <>
            <Container className="pt-3">
                <Row>
                    <Col>
                        <p><em>* Our menu is subject to change. Please see your nearest location for an updated list of menu items.</em></p>
                    </Col>
                </Row>
            </Container>
                ...
                <Container className="border border-dark menu">
                    ...
                    <Row>
                        <Col className="menu-text">
                            <p><small><em>* Non-dairy substitutes are always available upon request.</em></small></p>
                        </Col>
                    </Row>
                </Container>
            </Container>
